  ...
  return (
    <div className='relative mt-30'>
      <div className='flex flex-col justify-center items-center'>
        <h1 className='flex text-center hero-title text-4xl font-medium text-white justify-center'>Isu Saat Ini</h1>
      ...
      <div className='mx-14 flex justify-center gap-5'>
        ...
        <div className='bg-[#F5F5DC] mt-10 w-[560px] relative '>
          <img className='absolute bottom-0 right-0' src="/gambar/daun.png" alt="" />
      ...
      <div className='mx-14 flex gap-5 justify-center'>
         <div className='bg-[#F5F5DC] mt-5 w-[560px] relative '>
          <img className='absolute bottom-0 right-0' src="/gambar/daun.png" alt="" />
        ...
        <div className='bg-[#F5F5DC] mt-5 w-[870px] relative'>
          <img className='absolute bottom-0 right-0' src="/gambar/daun.png" alt="" />
